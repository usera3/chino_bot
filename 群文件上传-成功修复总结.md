...
**结果**: ✅ 成功
```
⚠️ 文件将保存到: ~/Downloads/test_word_upload.docx
✅ Word 文档创建成功！
📁 文件：~/Downloads/test_word_upload.docx
📊 大小：36.14 KB
...
**结果**: ✅ 成功
```
⚠️ 文件将保存到: ~/Downloads/test_send_document.docx
✅ Word 文档创建成功！
📁 文件：~/Downloads/test_send_document.docx
📊 大小：36.09 KB
