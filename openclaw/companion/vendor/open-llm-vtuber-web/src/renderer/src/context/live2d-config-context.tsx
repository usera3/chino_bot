...
export interface ModelInfo {
  ...
  /** Optional visible fallback image when Live2D body is not visible */
  fallbackImageUrl?: string;

  /** Fallback image height in CSS pixels */
  fallbackHeight?: number;

  /** Fallback image left offset in CSS pixels */
  fallbackLeft?: number;

  /** Fallback image bottom offset in CSS pixels */
  fallbackBottom?: number;

  /** Fallback image top anchor percentage for vertical centering */
  fallbackTopPercent?: number;
